...
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    ...
    <form method="post" id="store-form"  action="" class="dokan-form-horizontal">
            ...
            <div class="dokan-banner">
                ...
                <div class="button-area<?php echo $banner_id ? ' dokan-hide' : ''; ?>">
                    ...
                    <p class="help-block">
                        ...
                        $help_text = sprintf(
                            __('Upload a banner for your portfolio. Banner size is (%sx%s) pixels.', 'dokan-lite' ),
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="dokan_gravatar"><?php esc_html_e( 'Portfolio Picture / Logo', 'dokan-lite' ); ?></label>
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="dokan_store_ppp"><?php esc_html_e( 'Shindigs Listed on Porfolio', 'dokan-lite' ); ?></label>
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label"><?php esc_html_e( 'More Shindigs', 'dokan-lite' ); ?></label>
            <div class="dokan-w5 dokan-text-left">
                <div class="checkbox">
                    <label>
                        <input type="hidden" name="setting_show_more_ptab" value="no">
                        <input type="checkbox" name="setting_show_more_ptab" value="yes"<?php checked( $show_more_ptab, 'yes' ); ?>> <?php esc_html_e( 'Enable tab on Shindig single page view', 'dokan-lite' ); ?>
                    </label>
                </div>
            </div>
        </div>
