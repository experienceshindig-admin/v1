...
if (jQuery(".biowrapper").height() > 208 {
...
} else if (jQuery(".biowrapper").height() <= 208) {
jQuery( ".biolink" ).hide();
jQuery(".biosmall").removeClass('biosmall').addClass('biobig');
}
});
jQuery(document).ready(function () {
if (jQuery(".sdwrapper").height() > 156) {
...
} else if (jQuery(".sdwrapper").height() <= 156){
jQuery( ".sdlink" ).hide();
jQuery(".sdsmall").removeClass('sdsmall').addClass('sdbig');
}
});
jQuery(document).ready(function () {
if (jQuery(".ldwrapper").height() > 156) {
...
} else if (jQuery(".ldwrapper").height() <= 156) {
jQuery( ".ldlink" ).hide();
